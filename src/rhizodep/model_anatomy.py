...
class RootAnatomy:
    ...
    root_hair_length: float = field(default=1.e-3, metadata=dict(unit="m", unit_comment="", description="Example root hair length", value_comment="", references="According to the work of Gahoonia et al. (1997), the root hair maximal length for wheat and barley evolves between 0.5 and 1.3 mm.", variable_type="input", by="model_growth", state_variable_type=""))
    total_root_hairs_number: float = field(default=30 * (1.6e-4 / radius) * length * 1e3, metadata=dict(unit="adim", unit_comment="", description="Example root hairs number on segment external surface", value_comment="", references=" According to the work of Gahoonia et al. (1997), the root hair density is about 30 hairs per mm for winter wheat, for a root radius of about 0.16 mm.", variable_type="input", by="model_growth", state_variable_type=""))
    ...
    xylem_exchange_surface: float = field(default=0., metadata=dict(unit="m2", unit_comment="", description="Exchange surface between root parenchyma and apoplasmic xylem vessels.", value_comment="", references="", variable_type="state_variable", by="model_anatomy", state_variable_type="extensive"))
    ...
    # Volumes
    xylem_volume: float = field(default=0., metadata=dict(unit="m3", unit_comment="", description="xylem volume for water transport between elements", value_comment="", references="", variable_type="state_variable", by="model_anatomy", state_variable_type="extensive"))

    # Differentiation factors
    endodermis_conductance_factor: float = field(default=1., metadata=dict(unit="adim", unit_comment="", description="The endodermis barrier differentiation factor", value_comment="", references="", variable_type="state_variable", by="model_anatomy", state_variable_type="intensive"))
    epidermis_conductance_factor: float = field(default=0.5, metadata=dict(unit="adim", unit_comment="", description="The epidermis barrier differentiation factor", value_comment="", references="", variable_type="state_variable", by="model_anatomy", state_variable_type="intensive"))
    xylem_differentiation_factor: float = field(default=1., metadata=dict(unit="adim", unit_comment="", description="Xylem differentiation, i.e. apoplasmic opening, from 0 to 1", value_comment="", references="", variable_type="state_variable", by="model_anatomy", state_variable_type="instensive"))
    ...
    begin_xylem_differentiation: float = field(default=0., metadata=dict(unit="s", unit_comment="time equivalent at T_ref", description="Parameter indicating at which age xylem differentiation starts for a logistic function", value_comment="", references="", variable_type="parameter", by="model_anatomy", state_variable_type=""))
    ...
    # Surfacic fractions
    cortical_surfacic_fraction: float = field(default=29., metadata=dict(unit="adim", unit_comment="", description="Cortex (+epidermis) parenchyma surface ratio over root segment's cylinder surface", value_comment="", references="report", variable_type="parameter", by="model_anatomy", state_variable_type=""))
    stellar_surfacic_fraction: float = field(default=11., metadata=dict(unit="adim", unit_comment="", description="Stele (+endodermis) surface ratio over root segment's cylinder surface", value_comment="", references="report", variable_type="parameter", by="model_anatomy", state_variable_type=""))
    phloem_surfacic_fraction: float = field(default=2.5, metadata=dict(unit="adim", unit_comment="", description="phloem surface ratio over root's cylinder surface", value_comment="", references="report", variable_type="parameter", by="model_anatomy", state_variable_type=""))
